...
// creating a signing session. It validates a configured TSA URL, but cannot enforce that B-T
// requires a TSA because conformance is part of the later signing request. BeginSigning validates
// again and enforces that request-dependent rule as defense in depth.
